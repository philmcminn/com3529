...
% Diagram of crossover --- from slide 
...
% Slide for the Triangle program (from Symbolic Execution)
...
% the usual diagram of combining branch predicate with approach level.
